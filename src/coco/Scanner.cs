...
public class Buffer {
...
#if PEBBLE_LAMBDA
			// DOTNETCORE1.0 uses this function instead of Close().
			stream.Dispose();
#else
			stream.Close();
#endif
	...
	public virtual string GetString (int beg, int end) {
		int len = 0;
...
//-----------------------------------------------------------------------------------
// SimpleBuffer
// - PRC: This provides the Buffer interface that the Scanner wants, but just wraps a simple string.
//-----------------------------------------------------------------------------------
...
public class SimpleBuffer : Buffer {
	...
	public SimpleBuffer(string s) : base() {
		_s = s;
		_curPos = 0;
		_fileLen = _s.Length;
	}
	...
	public override string GetString (int beg, int end) {
		return _s.Substring(beg, end - beg);
	}
...
//PRC: I added this because apparently this class isn't available in 
// dotnetcore 1.0, which is what AWS Lambda uses.
#if PEBBLE_LAMBDA
...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 48; i <= 57; ++i) start[i] = 18;
		start[46] = 51; 
		start[34] = 13; 
		start[60] = 52; 
		start[44] = 19; 
	...
	void CheckLiteral() {
		switch (t.val) {
			...
			case "this": t.kind = 49; break;
			case "catch": t.kind = 50; break;
			case "true": t.kind = 51; break;
			case "false": t.kind = 52; break;
			case "null": t.kind = 53; break;
			case "for": t.kind = 54; break;
			case "foreach": t.kind = 55; break;
			case "in": t.kind = 56; break;
			case "typealias": t.kind = 57; break;
			case "if": t.kind = 58; break;
			case "else": t.kind = 59; break;
			case "break": t.kind = 60; break;
			case "continue": t.kind = 61; break;
			case "return": t.kind = 62; break;
			case "sealed": t.kind = 65; break;
			case "uninstantiable": t.kind = 66; break;
			case "class": t.kind = 67; break;
			case "constructor": t.kind = 68; break;
			case "enum": t.kind = 69; break;
			case "assert": t.kind = 70; break;
			default: break;
		}
	}
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 15:
				if (ch == '"' || ch == 92 || ch == 'n' || ch == 't') {AddCh(); goto case 14;}
				else {goto case 0;}
			case 16:
				if (ch == '"' || ch == 92 || ch == 'n' || ch == 't') {AddCh(); goto case 14;}
				else {goto case 0;}
